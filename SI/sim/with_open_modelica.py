model DIPC "double inverted pendulum on a cart"
  ...
  parameter input Modelica.SIunits.RotationalDampingConstant top_friction = 0.001 "friction of cart joint" annotation(Dialog(group = "Variables", showStartAttribute = true));
  parameter input Modelica.SIunits.RotationalDampingConstant end_friction = 0.001 "friction of mid-pend joint" annotation(Dialog(group = "Variables", showStartAttribute = true));
  parameter input Modelica.SIunits.Mass top_mass = 0.1 "mass of first pendulum";
  parameter input Modelica.SIunits.Mass end_mass = 0.1 "mass of end pendulum";
  parameter input Modelica.SIunits.Length top_L = 0.3 "length of top pendulum";
  parameter input Modelica.SIunits.Length top_lc = 0.15 "distance from cart pivot to first pendulum COM";
  parameter input Modelica.SIunits.Length end_lc = 0.15 "distance from mid pivot to end pendulum COM";
  parameter input Modelica.SIunits.MomentOfInertia top_inertia = 0.001 "top pendulum rotational inertia about z axis";
  parameter input Modelica.SIunits.MomentOfInertia end_inertia = 0.001 "end pendulum rotational inertia about z axis";
  parameter input Modelica.SIunits.Length end_L = 0.3 "length of end pendulum";
...
equation
  ...
  connect(u, accelerate1.a_ref) annotation(Line(visible = true, origin = {-141, 45}, points = {{-14, 0}, {14, 0}}, color = {1, 37, 163}));
  ...
  annotation(uses(Modelica(version = "3.2.3"), IntroductoryExamples(version = "13.3")), experiment(StopTime = 10.0, __Wolfram_Algorithm = "dassl"), Diagram(coordinateSystem(extent = {{-160, -155}, {150, 90}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, lineColor = {0, 114, 195}, fillColor = {255, 255, 255}, extent = {{-100, -100}, {100, 100}}, radius = 25), Text(visible = true, textColor = {64, 64, 64}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
end DIPC;