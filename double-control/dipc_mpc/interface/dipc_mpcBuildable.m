...
% 
classdef dipc_mpcBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'dipc_mpc'))
                solverpath = fullfile(buildablepath, 'dipc_mpc');
            end
            solverInfo = struct();
            solverInfo.solvername = 'dipc_mpc';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = dipc_mpcBuildable.forcesCall(params.x0, params.xinit, params.all_parameters);
        end
        ...
        function [output, exitflag, info] = forcesCall(x0, xinit, all_parameters)
            ...
            [output_c, exitflag_c, info_c] = dipc_mpcBuildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = dipc_mpcBuildable.forcesInitOutputsMatlab();
