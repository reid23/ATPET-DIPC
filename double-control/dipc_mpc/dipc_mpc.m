% dipc_mpc - a fast solver generated by FORCESPRO v6.3.0
%
%   OUTPUT = dipc_mpc(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = dipc_mpc(PARAMS) returns additionally
...
%
%   [OUTPUT, EXITFLAG, INFO] = dipc_mpc(PARAMS) returns 
